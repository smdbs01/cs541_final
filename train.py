...
from datasets.vision_dataset import NSLT as Dataset
...
def run(
    ...
    dataset = Dataset(train_split_file, "train", root_dir, mode, train_transforms)
    ...
    val_dataset = Dataset(train_split_file, "test", root_dir, mode, test_transforms)
